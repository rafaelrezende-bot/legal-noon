...
export function DashboardSummary({ totalMonth, overdue, next7Days, completedMonth }: Props) {
  const cards = [
    { label: 'Obrigacoes do mes', value: totalMonth, icon: CalendarDays, color: '#1E7FA8', bg: '#EBF5FA' },
    { label: 'Atrasadas', value: overdue, icon: AlertTriangle, color: '#DC2626', bg: '#FEF2F2' },
    { label: 'Proximos 7 dias', value: next7Days, icon: Clock, color: '#F59E0B', bg: '#FFFBEB' },
    { label: 'Concluidas no mes', value: completedMonth, icon: CheckCircle2, color: '#16A34A', bg: '#F0FDF4' },
  ]
  return (
