      ...
      <Card className="w-full max-w-sm p-8">
        ...
        {sent ? (
          <div className="text-center">
            ...
            <Link href="/login" className="text-sm font-medium" style={{ color: '#1E7FA8' }}>Voltar ao login</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center">
              <Link href="/login" className="text-sm text-gray-500 hover:text-gray-700">Voltar ao login</Link>
            </div>
          </form>
        )}
      </Card>
